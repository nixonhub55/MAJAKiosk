...
class Traffic extends Controller
{
    ...
    public function show_sc_pending(){
        ...
        $data['sched_details']=$this->authentication->sp_application_info([0,6,$id,0,'P','1991-01-01','',$_POST['r_opt'] ?? '']);
 ...
 */
    ...
    public function show_sc_approval(){ 
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId');
        $data['list'] = $this->authentication->sp_application_info([1,6,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
        $num = 0;
    ...
    public function show_sc_application(){
        ...
        $identityId = session()->get('identityId');
        $data['pending_list'] = $this->authentication->sp_application_info([0,6,0,$identityId,'P','','',$_POST['r_opt'] ?? '']); 
        $data['request_history'] = []; 
    ...
    public function showOvertimeApproval(){
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId');
        $data['list'] = $this->authentication->sp_application_info([1,0,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
    ...
    public function overtimeExt_approval(){
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId');
        $data['list'] = $this->authentication->sp_application_info([1,1000,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
    ...
    public function showOffSetApproval(){ 
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId');
        $data['list'] =$this->authentication->sp_application_info([1,4,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']); 
        $num = 0;
        foreach ($data['list']['rows'] as $rows) {
            $enc_id = $rows->osAppNo;
            $enc_pay = $rows->approverLocked;
    ...
    public function show_os_request_detail() {  
        ...
        $data['id'] = $this->authentication->f_endecrypt($_POST['id'], 'd', $identityId);
        $data['enc_pay'] = $this->authentication->f_endecrypt($_POST['enc_pay'], 'd', $identityId);
        $data['details'] = $this->authentication->sp_application_info([0,4,$data['id'],0,'F','1991-01-01','',$_POST['r_opt'] ?? '']); 
    ...
    public function LeaveSetApproval(){  
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId');
        $data['list'] = $this->authentication->sp_application_info([1,1,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);  
        $num = 0;
        foreach ($data['list']['rows'] as $rows) {
            $enc_id = $rows->laAppNo;
            $enc_pay = $rows->approverLocked;
    ...
    public function show_Time_Entry_Details(){
        ...
        $data['id'] = $this->authentication->f_endecrypt($_POST['id'], 'd', $identityId);
        $data['enc_pay'] = $this->authentication->f_endecrypt($_POST['enc_pay'], 'd', $identityId);
        $data['details'] =  $this->authentication->sp_application_info([0,5,$data['id'],$identityId,'F','','',$_POST['r_opt'] ?? '']);
        //echo $_POST['r_opt'];
    ...
    public function show_Time_Entry_approval(){  
        ...
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId'); 
        $data['list'] =$this->authentication->sp_application_info([1,5, 0, $identityId ,'F','1991-01-01','',$_POST['r_opt'] ?? '']); 
        $num = 0;
        foreach ($data['list']['rows'] as $rows) {
            $enc_id = $rows->teAppNo;
            $enc_pay = $rows->approverLocked;
    ...
    {  
        ...
        $data['id'] = $this->authentication->f_endecrypt($_POST['id'], 'd', $identityId);
        $data['enc_pay'] = $this->authentication->f_endecrypt($_POST['enc_pay'], 'd', $identityId);
        $data['details'] =  $this->authentication->sp_application_info([0,1, $data['id'],0,'F','1991-01-01','',$_POST['r_opt'] ?? '']); 
        //echo $_POST['r_opt'];
    ...
    public function TimeAdjustmentSetApproval(){
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId'); 
        $data['list'] =$this->authentication->sp_application_info([1,2, 0, $identityId ,'F','1991-01-01','',$_POST['r_opt'] ?? '']); 
        $num = 0;
        foreach ($data['list']['rows'] as $rows) {
            $enc_id = $rows->taAppNo;
            $enc_pay = $rows->approverLocked;
    ...
    public function show_sc_request_detail(){
        ...
        $data['id'] = $this->authentication->f_endecrypt($_POST['id'], 'd', $identityId);
        $data['enc_pay'] = $this->authentication->f_endecrypt($_POST['enc_pay'], 'd', $identityId);
        $data['details'] = $this->authentication->sp_application_info([0,6, $data['id'],0,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
    ...
    public function show_ta_request_detail(){ 
        ...
        $data['id'] = $this->authentication->f_endecrypt($_POST['id'], 'd', $identityId);
        $data['enc_pay'] = $this->authentication->f_endecrypt($_POST['enc_pay'], 'd', $identityId);
        $data['details'] = $this->authentication->sp_application_info([0,2, $data['id'],0,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
    ...
    public function OBSetApproval(){ 
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId'); 
        $data['list'] = $this->authentication->sp_application_info([1,3, 0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);  
        $num = 0;
        foreach ($data['list']['rows'] as $rows) {
            $enc_id = $rows->obAppNo;
            $enc_pay = $rows->approverLocked;
    ...
    public function show_ob_request_detail(){ 
        ...
        $data['details'] = $this->authentication->sp_application_info([0,3, $data['id'] ,0,'F','1991-01-01','',$_POST['r_opt'] ?? '']); 
    ...
    public function submit_filter_request(){
        ...
        $data['request_history'] =$this->authentication->sp_application_info([$pint_mode,$switch,0,$identityId,$status,$df,$dt,$_POST['r_opt'] ?? '']);
    ...
    public function show_hist_details_form()  {
        ...
        $data['app_details'] =  $this->authentication->sp_application_info([0,$num,$id,0,'F','','',$_POST['r_opt'] ?? '']);
    ...
    public function validate_request(){
        ...
        if ($mode == 10) {  /*For Approval Notifiations*/
            ...
            $ot_rows = $this->authentication->sp_application_info([1,0,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
            $leave_rows = $this->authentication->sp_application_info([1,1,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
            $ta_rows = $this->authentication->sp_application_info([1,2,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
            $ob_rows = $this->authentication->sp_application_info([1,3,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
            $os_rows = $this->authentication->sp_application_info([1,4,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
            $te_rows = $this->authentication->sp_application_info([1,5,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
            $sc_rows = $this->authentication->sp_application_info([1,6,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
            $hrd_rows = $this->authentication->sp_application_info([1,7,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
            $otExt_rows = $this->authentication->sp_application_info([1,1000,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
    ...
    public function hrd_application(){
        $this->DisconnectDB(); 
        $identityId = session()->get('identityId');  
        $data['pending_list'] = $this->authentication->sp_application_info([0,7,0,$identityId,'P','','','',$_POST['r_opt'] ?? '']);  
        $data['status'] = $this->authentication->sp_dropdown_fill([4, 0]);
    ...
    public function hrd_application_dtls(){ 
        ...
        $data['user_details'] = $this->authentication->get_identity_sp([0, $identityId]);
        $data['appNoInfo'] = $this->authentication->sp_application_info([0,7,$data['appNo'],0,'H','','',$_POST['r_opt'] ?? '']);  
    ...
    public function HRDApproval(){
        ...
        $data['list'] = $this->authentication->sp_application_info([1,7,0,$identityId,'F','1991-01-01','',$_POST['r_opt'] ?? '']);
    ...
    public function show_Time_Entry(){ 
       ...
       foreach(session()->get('access_rights')['rows'] as $rows){
        ...
        $identityId = session()->get('identityId'); 
        $data['pending_list'] = $this->authentication->sp_application_info([0,5,0,$identityId,'P','','',$_POST['r_opt'] ?? '']);  
        $data['history'] = $this->authentication->sp_application_info([0,5,0,$identityId,'H','','',$_POST['r_opt'] ?? '']);  
        $num = 0;
        foreach ($data['pending_list']['rows'] as $rows) {
            $enc_id = $rows->teAppNo; 
            $data['pending_list']['rows'][$num]->enc_id = $this->authentication->f_endecrypt($enc_id, 'e', $identityId); 
    ...
    public function show_Time_Entry_Form(){
        ...
        $data['selected_row'] = $this->authentication->sp_application_info([0,5,$id,0,'F','','',$_POST['r_opt'] ?? '']);  
        $data['user_details'] = $this->authentication->get_identity_sp([0, $identityId]);
    ...
    public function overtime_application() {
        ...
        $identityId = session()->get('identityId');  
        $data['ot_list'] = $this->authentication->sp_application_info([0,0,0,$identityId,'P','','',$_POST['r_opt'] ?? '']); 
        $data['request_history'] = []; 
    ...
    public function show_overtime_form(){
        ...
        $data['overtime'] =  $this->authentication->sp_application_info([0,0,$id,0,'P','','',$_POST['r_opt'] ?? '']);  
    ...
    public function overtimeExt_application() {
        ...
        $identityId = session()->get('identityId');  
        $data['ot_list'] = $this->authentication->sp_application_info([0,1000,0,$identityId,'P','','',$_POST['r_opt'] ?? '']); 
        $data['request_history'] = []; 
    ...
    public function show_overtimeExt_form(){
        ...
        $params = [0];
        $rows = $this->authentication->exec_store_proc('sp_get_locations', $params); 
        $data['overtime'] =  $this->authentication->sp_application_info([0,1000,$id,0,'P','','',$_POST['r_opt'] ?? '']);  
        $data['ot_types'] = $this->overtime_model->sp_dropdown_fill([0, 0]);
        $data['kiosklocked'] = $this->authentication->sp_get_payrollperiod_kiosk([0, $identityId]);
        $data['user_details'] = $this->authentication->get_identity_sp([0, $identityId]);
        $data['locations'] = $rows; 
    ...
    public function offset_application(){ 
        ...
        $identityId = session()->get('identityId');
        $data['app_list'] =$this->authentication->sp_application_info([0,4,0,$identityId,'P','','',$_POST['r_opt'] ?? '']); 
        $num = 0;
    ...
    public function show_offset_form(){
        ...
        $data['kiosklocked'] = $this->authentication->sp_get_payrollperiod_kiosk([0, $identityId]);
        $data['app_details'] = $this->authentication->sp_application_info([0,4,$r_id,0,'P','','',$_POST['r_opt'] ?? '']);
    ...
    public function time_adj_application(){
        ...
        $identityId = session()->get('identityId');
        $data =$this->authentication->sp_application_info([0,2,0,$identityId,'P','','',$_POST['r_opt'] ?? '']); 
        $num = 0;
    ...
    public function show_time_adjustment_form(){
        ...
        $data['id'] = $id;
        $data['kiosklocked'] = $this->authentication->sp_get_payrollperiod_kiosk([0, $identityId]);
        $data['selected_row'] = $this->authentication->sp_application_info([0,2,$id,$identityId,'P','','',$_POST['r_opt'] ?? '']);
        $data['user_details'] = $this->authentication->get_identity_sp([0, $identityId]);
    ...
    public function ob_application(){
        ...
        $identityId = session()->get('identityId');
        $data = $this->authentication->sp_application_info([0,3,0,$identityId,'P','','',$_POST['r_opt'] ?? '']);
        $num = 0;
        foreach ($data['rows'] as $rows) {
    ...
    public function show_ob_app_form(){
        ...
        $data['user_details'] = $this->authentication->get_identity_sp([0, $identityId]);
        $data['selected_row'] = $this->authentication->sp_application_info([0,3,$r_id,0,'P','','',$_POST['r_opt'] ?? '']);
