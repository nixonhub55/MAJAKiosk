...
-- CALL sp_application_info(1,6,0,'0601200169','F','1991-01-01','',@num,@msg); SELECT @msg     
DELIMITER $$ 
...
proc_start:BEGIN 
	...
	-- CALL sp_application_info(0,6,0,'0601200005','P','','',@num,@msg); SELECT @msg    
	...
	SELECT DISTINCT  t1.*
	       ...
	       ,CONCAT(payrollPeriodFrom,' To ',payrollPeriodTo) AS payrollDateRange 
	       ,dep.departmentName
	       ,cost.costName 
